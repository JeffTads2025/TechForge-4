...
function imprimirAreas(figuras) {
    ...
    figuras.forEach(function (figura, index) {
        ...
        console.log("Figura ".concat(index + 1, " (").concat(figura.constructor.name, "): \u00C1rea = ").concat(area.toFixed(2)));
    });
}
var meuCirculo = new Circulo(5);
var meuQuadrado = new Quadrado(4);
var meuTriangulo = new Triangulo(6, 8);
var formas = [
    meuCirculo,
    meuQuadrado,
    meuTriangulo
